...
FAQ_DATA_FR = [
    # BLOC 1: ACHETER (Le plus important pour les nouveaux utilisateurs)
    {
    ...
    # BLOC 2: VENDRE (Important pour les vendeurs potentiels)
    {
    ...
    # BLOC 3: SUPPORT (Important pour résolution problèmes)
    {
        "category": "SUPPORT",
    ...
    # BLOC 4: BIBLIOTHÈQUE (Utile après achat)
    {
    ...
    # BLOC 6: DÉTAILS TECHNIQUES (Moins prioritaire, à la fin)
    {
