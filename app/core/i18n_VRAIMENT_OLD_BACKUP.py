...
TEXTS: Dict[str, Dict[str, str]] = {
    'fr': {
        ...
        # Buy menu text
        'buy_menu_text': """🛒 **ACHETER UNE FORMATION**\n\n🎯 **Plus de 100+ formations premium disponibles**\n\n🔍 **Recherche directe** - Vous avez déjà un ID produit ?\n📂 **Par catégories** - Explorez nos 6 domaines d'expertise\n🔥 **Tendances** - Les formations les plus vendues\n🆕 **Nouveautés** - Derniers ajouts de nos experts\n\n💎 **Pourquoi choisir TechBot Marketplace ?**\n• ✅ Formations créées par des experts certifiés\n• ⚡ Livraison instantanée après paiement\n• 🔐 Paiements 100% sécurisés via blockchain\n• 💬 Support 24/7 pour tous vos achats""",
        # Sell menu text
        'sell_menu_text': """🎓 **DEVENEZ FORMATEUR SUR TECHBOT**\n\n💰 **Transformez votre expertise en revenus passifs**\n\n🚀 **Pourquoi vendre chez nous ?**\n• 💎 **95% des revenus pour vous** (commission 5% seulement)\n• ⚡ **Paiements automatiques en crypto** après chaque vente\n• 🔐 **Adresse Solana personnelle** - Recevez directement vos gains\n• 📈 **Dashboard vendeur complet** avec analytics détaillées\n• 🎯 **Marketplace établie** avec trafic qualifié\n• 📧 **Support premium** pour optimiser vos ventes\n\n✅ **Formats acceptés :** PDF, ZIP, Vidéos, Documents\n📊 **Déjà 500+ formations vendues** sur la plateforme\n\n🔑 **Compte sécurisé** avec récupération par email""",
        # Search
