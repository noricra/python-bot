...
class MarketplaceBot:
    ...
    # button_handler déplacé vers app.integrations.telegram.handlers.button
...
🔥 **Top catégories :**"""
    ...
    # handle_text_message déplacé vers app.integrations.telegram.handlers.text
...
💸 **Moyenne par vente :** {total_volume/max(total_sales,1):.2f}€"""
    ...
    # handle_document_upload déplacé vers app.integrations.telegram.handlers.documents
